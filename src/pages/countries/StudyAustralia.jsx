...
function StudyAustralia() {
  ...
  return (
    <div className="w-full flex flex-col items-center space-y-8">
      ...
      <div className="w-full p-6">
        ...
        <div className="flex flex-col md:flex-row items-start w-full">
          ...
          <div className="w-full md:w-1/2 space-y-4">
            {ausTestAccordion.map((item, index) => {
          ...
          <table className="min-w-[250px] md:min-w-full bg-white border border-gray-500 text-sm md:text-base mt-8">
            ...
            <tbody>
              <tr className="hover:bg-red-200">
                <td className="py-3 px-4 border-b font-medium">Product Design</td>
                <td className="py-3 px-4 border-b">1.5 - 2 year</td>
                <td className="py-3 px-4 border-b">AUD 25,000 - 40,000</td>
                <td className="py-3 px-4 border-b">✔️</td>
              </tr>

              <tr className="hover:bg-red-200">
                <td className="py-3 px-4 border-b font-medium">AI and Data Analytics</td>
                <td className="py-3 px-4 border-b"> 1- 1.5 year</td>
                <td className="py-3 px-4 border-b">AUD 30,000 - 45,000</td>
                <td className="py-3 px-4 border-b">✔️</td>
              </tr>
              <tr className="hover:bg-red-200">
              ...
              <tr className="hover:bg-red-200">
                <td className="py-3 px-4 border-b font-medium">Supply Chain Management</td>
                <td className="py-3 px-4 border-b">1.5 - 2 year</td>
                <td className="py-3 px-4 border-b">AUD 30,000 - 50,000</td>
                <td className="py-3 px-4 border-b">✔️</td>
              </tr>
              <tr className="hover:bg-red-200">
              ...
              <tr className="hover:bg-red-200">
                <td className="py-3 px-4 border-b font-medium">Biomedical Engineering</td>
                <td className="py-3 px-4 border-b">2 year</td>
                <td className="py-3 px-4 border-b">AUD 35,000 - 50,000</td>
                <td className="py-3 px-4 border-b">✔️</td>
              </tr>
              <tr className="hover:bg-red-200">
        ...
        <div className="w-full flex flex-col md:flex-row gap-8">
          ...
          <div className="md:w-2/3 w-full bg-white rounded-xl p-6 shadow-md">
            <h3 className="text-2xl font-bold text-blue-700 mb-4">
              {ausInfo[activeIndex].title}
            </h3>
            <p className="text-black whitespace-pre-line">
              {ausInfo[activeIndex].content}
            </p>
          ...
          <div className="md:w-1/3 w-full flex justify-center items-start">
            <img
              src={ausInfo[activeIndex].image}
              alt={ausInfo[activeIndex].title}
      ...
      >
        {/* Australia best university */}
        <h2 className="text-2xl font-bold text-center mb-6 text-white">Best University In Australia</h2>
        {/* Slideshow Image with 80% width and 10% side margins */}
        <div className="w-[80%] mx-auto">
          <img
            src={images[current]}
            alt={`Aus Slide ${current + 1}`}
