  ...
  return (
    ...
    <div className="w-full flex flex-col items-center space-y-8">
      ...
      <div className='bg-pink-100 w-full'>
        <h3 className="text-xl mb-6 sm:text-2xl md:text-3xl font-bold text-center mt-4"><strong>Why To Study In Canada</strong></h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 px-4 md:px-16 w-full mb-10 mt-8">
          {whyToStudyCanada.map((card, index) => (
            <div
              key={index}
      ...
      <div className="w-full p-6">
        <h2 className="text-xl mb-6 sm:text-2xl md:text-3xl font-bold text-center">
          <strong>Tests Required to Study in Canada</strong>
        </h2>

        <div className="flex flex-col md:flex-row items-start w-full">
          {/* Accordion Section */}
          <div className="w-full md:w-1/2 space-y-4">
            {canadaTestAccordion.map((item, index) => {
      ...
      {/* Courses in Canada  */}
      <div className='w-full bg-cover bg-center bg-no-repeat' style={{ backgroundImage: "url('src/assets/img/countries/canada/canada-bg.png')" }}>
        <div className="px-4 md:px-8 w-full overflow-x-auto mb-10">
          <h3 className="text-xl mt-4 mb-6 sm:text-2xl md:text-3xl mt-4 text-white font-bold text-center"><strong>Popular Courses to Study in CANADA</strong></h3>
          <table className="min-w-[250px] md:min-w-full bg-white border border-gray-500 text-sm md:text-base mt-8">
            ...
            <tbody>
              <tr className="hover:bg-red-200">
                ...
                <td className="py-3 px-4 border-b">1.5 - 2 years</td>
                <td className="py-3 px-4 border-b">$15,000 - $35,000</td>
                <td className="py-3 px-4 border-b">✔️</td>
              </tr>

              <tr className="hover:bg-red-200">
                <td className="py-3 px-4 border-b font-medium">Information Technology & Computer Science</td>
                <td className="py-3 px-4 border-b">2 Years</td>
                <td className="py-3 px-4 border-b">$20,000 - $40,000</td>
                <td className="py-3 px-4 border-b">✔️</td>
              </tr>
              <tr className="hover:bg-red-200">
                <td className="py-3 px-4 border-b font-medium">Media & Journalism</td>
                <td className="py-3 px-4 border-b">1 - 2 Years</td>
                <td className="py-3 px-4 border-b">$15,000 - $30,000</td>
                <td className="py-3 px-4 border-b">✔️</td>
              </tr>
              <tr className="hover:bg-red-200">
                <td className="py-3 px-4 border-b font-medium">Human Resources</td>
                <td className="py-3 px-4 border-b">1 - 1.5 Years</td>
                <td className="py-3 px-4 border-b">	$15,000 - $30,000</td>
                <td className="py-3 px-4 border-b ml-4">✔️</td>
              </tr>
              <tr className="hover:bg-red-200">
                <td className="py-3 px-4 border-b font-medium">Project Management</td>
                <td className="py-3 px-4 border-b">1 - 1.5 Years</td>
                <td className="py-3 px-4 border-b">	$20,000 - $30,000</td>
                <td className="py-3 px-4 border-b">✔️</td>
              </tr>
              <tr className="hover:bg-red-200">
                <td className="py-3 px-4 border-b font-medium">Accounting and Finance</td>
                <td className="py-3 px-4 border-b">1 - 2 Years</td>
                <td className="py-3 px-4 border-b">$20,000 - $40,000</td>
                <td className="py-3 px-4 border-b">✔️</td>
              </tr>
              ...
              <tr className="hover:bg-red-200">
                <td className="py-3 px-4 border-b font-medium">Graphic Design</td>
                <td className="py-3 px-4 border-b">1 - 2 Years</td>
                <td className="py-3 px-4 border-b">	$15,000 - $30,000</td>
                <td className="py-3 px-4 border-b">✔️</td>
              </tr>
      ...
      <div className="w-full px-6 md:px-16 py-10 bg-gray-50">
        {/* Heading */}
        <h3 className="text-xl mb-6 sm:text-2xl md:text-3xl font-bold text-center">
          <strong>All you need to know about Study in Canada</strong>
        </h3>
        ...
        <div className="w-full flex flex-col md:flex-row gap-8">
          ...
          <div className="md:w-2/3 w-full bg-white rounded-xl p-6 shadow-md">
            <h3 className="text-2xl font-bold text-blue-700 mb-4">
              {canadaInfo[activeIndex].title}
            </h3>
            <p className="text-black whitespace-pre-line">
              {canadaInfo[activeIndex].content}
            </p>
          ...
          <div className="md:w-1/3 w-full flex justify-center items-start">
            <img
              src={canadaInfo[activeIndex].image}
              alt={canadaInfo[activeIndex].title}
