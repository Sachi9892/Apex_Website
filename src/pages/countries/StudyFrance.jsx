  ...
  return (
    <div className="w-full flex flex-col items-center space-y-8">
      ...
      <div className='bg-pink-100 w-full'>
        <h3 className="text-xl mb-6 sm:text-2xl md:text-3xl font-bold text-center mt-4"><strong>Why To Study In France</strong></h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 px-4 md:px-16 w-full mb-10 mt-8">
          {whyToStudyFrance.map((card, index) => (
            <div
              key={index}
      ...
      {/* Tests Required to Study in France */}
      <div className="w-full p-6">
        <h3 className="text-xl mb-6 sm:text-2xl md:text-3xl font-bold text-center mt-4"><strong>Test Required To Study In France</strong></h3>

        <div className="flex flex-col md:flex-row items-start w-full">
          {/* Accordion Section */}
          <div className="w-full md:w-1/2 space-y-4">
            {franceTestAccordion.map((item, index) => {
          ...
          <div className="w-full md:w-1/2 mt-6 md:mt-0 flex justify-center">
            <img
              src="src/assets/img/countries/france/france-apex.png"
              alt="model"
      ...
      <div className='w-full bg-cover bg-center bg-no-repeat' style={{ backgroundImage: "url('src/assets/img/countries/france/france-bg.png')" }}>
        <div className="px-4 md:px-8 w-full overflow-x-auto mb-10">
          <h3 className="text-xl mb-6 sm:text-2xl md:text-3xl text-white font-bold text-center mt-4"><strong>Popular Courses In France</strong></h3>
      ...
      <div className="w-full px-6 md:px-16 py-10 bg-gray-50">
        {/* Heading */}
        <h3 className="text-xl mb-6 sm:text-2xl md:text-3xl font-bold text-center"><strong>All you need to know about Study in France </strong></h3>
        ...
        <div className="w-full flex flex-col md:flex-row gap-8">
          ...
          <div className="md:w-2/3 w-full bg-white rounded-xl p-6 shadow-md">
            <h3 className="text-2xl font-bold text-blue-700 mb-4">
              {franceInfo[activeIndex].title}
            </h3>
            <p className="text-black whitespace-pre-line">
              {franceInfo[activeIndex].content}
            </p>
          ...
          <div className="md:w-1/3 w-full flex justify-center items-start">
            <img
              src={franceInfo[activeIndex].image}
              alt={franceInfo[activeIndex].title}
