  ...
  return (
    <div className="w-full flex flex-col items-center space-y-8">
      ...
      <div className='bg-pink-100 w-full'>
        <h3 className="text-3xl font-semibold text-black-600 mt-10 text-center"><strong>Why To Study In Ireland</strong></h3>
      ...
      <div className='w-full bg-cover bg-center bg-no-repeat' style={{ backgroundImage: "url('src/assets/img/countries/usa/us-bg.png')" }}>
        <div className="px-4 md:px-8 w-full overflow-x-auto mb-10">
          <h3 className="text-3xl font-bold text-white mb-6 mt-10 text-center">Popular Courses to Study in Ireland</h3>
