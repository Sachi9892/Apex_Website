...
import { ukInfo, whyToStudyUk, ukTestAccordion, images } from '../../data/country/UkData';
  ...
  return (
    <div className="w-full flex flex-col items-center space-y-8">
      ...
      <div className='bg-pink-100 w-full'>
        <h3 className="text-xl mt-4 sm:text-2xl md:text-3xl font-bold text-center mt-2"><strong>Why To Study In UK</strong></h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 px-4 md:px-16 w-full mb-10 mt-8">
          {whyToStudyUk.map((card, index) => (
            <div
              key={index}
      ...
      <div className="w-full p-6">
        ...
        <div className="flex flex-col md:flex-row items-start w-full">
          ...
          <div className="w-full md:w-1/2 space-y-4">
            {ukTestAccordion.map((item, index) => {
          ...
          <table className="min-w-[250px] md:min-w-full bg-white border border-gray-500 text-sm md:text-base mt-8">
            <thead>
              <tr className="bg-gray-100 text-gray-600">
                ...
                <th className="text-left py-3 px-4 border-b">Level</th>
            ...
            <tbody>
              <tr className="hover:bg-red-200">
                ...
                <td className="py-3 px-4 border-b">PG</td>
                <td className="py-3 px-4 border-b">✔️</td>
              </tr>

              <tr className="hover:bg-red-200">
                <td className="py-3 px-4 border-b font-medium">Management</td>
                <td className="py-3 px-4 border-b">3 year</td>
                <td className="py-3 px-4 border-b">£12,000 - £25,000</td>
                <td className="py-3 px-4 border-b">UG</td>
                <td className="py-3 px-4 border-b">✔️</td>
              </tr>
              <tr className="hover:bg-red-200">
                <td className="py-3 px-4 border-b font-medium">Management</td>
              ...
              <tr className="hover:bg-red-200">
                <td className="py-3 px-4 border-b font-medium">International Management</td>
                <td className="py-3 px-4 border-b">1 Year</td>
                <td className="py-3 px-4 border-b">£15,000 - £25,000</td>
                <td className="py-3 px-4 border-b">PG</td>
              ...
              <tr className="hover:bg-red-200">
                <td className="py-3 px-4 border-b font-medium">Nursing</td>
                <td className="py-3 px-4 border-b">3 Year</td>
                <td className="py-3 px-4 border-b">£15,000 - £30,000</td>
                <td className="py-3 px-4 border-b">PG</td>
                <td className="py-3 px-4 border-b ml-4">✔️</td>
              ...
              <tr className="hover:bg-red-200">
                <td className="py-3 px-4 border-b font-medium">Physiotherapy</td>
                <td className="py-3 px-4 border-b">3 Year</td>
                <td className="py-3 px-4 border-b">£12,000 - £25,000</td>
                <td className="py-3 px-4 border-b">PG</td>
                <td className="py-3 px-4 border-b ml-4">✔️</td>
      ...
      <div className="w-full px-6 md:px-16 py-10 bg-gray-50">
        {/* Heading */}
        <h3 className="text-xl mt-4 sm:text-2xl md:text-3xl font-bold text-center mb-6"><strong>All you need to know about Study in UK</strong></h3>
        ...
        <div className="w-full flex flex-col md:flex-row gap-8">
          ...
          <div className="md:w-2/3 w-full bg-white rounded-xl p-6 shadow-md">
            <h3 className="text-2xl font-bold text-blue-700 mb-4">
              {ukInfo[activeIndex].title}
            </h3>
            <p className="text-black whitespace-pre-line">
              {ukInfo[activeIndex].content}
            </p>
          ...
          <div className="md:w-1/3 w-full flex justify-center items-start">
            <img
              src={ukInfo[activeIndex].image}
              alt={ukInfo[activeIndex].title}
